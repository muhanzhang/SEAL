...
parse.add_argument("-u", "--users", help="users list")
parse.add_argument("-n", "--dimension", help="dimension of user profile")
parse.add_argument("-f", "--profile", help="profile information of nodes, corresponding to users list")
